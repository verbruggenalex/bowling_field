    ...
    attach: function (context, settings) {
      ...
      var reset_options = function(prev_val, next_input) {
        ...
        // disable the selectbox because it's not needed in case of a strike.
          ...
          next_input.find('option').attr('selected', 'selected');
          //next_input.prop('disabled', 'disabled');
        }
      };
      ...
      // // Find items.
      // $('.field--widget-bowling-field-scorecard').find('.trow.form-select', context).each(function () {
      //   $(this).closest('div').next().find('.trow.form-select').hide();
      // });

      // // Find items.
      // $('.field--widget-bowling-field-scorecard').find('.trow.form-select', context).change(function () {
      //   $(this).closest('div').next().find('.trow.form-select').toggle();
      // });
